      ...
      <ScrollView style={{paddingTop: 30}}>
        <WingBlank>
          ...
          <View style={localStyle.box}>
            ...
            <Button onPress={() => {this.props.navigation.push(PATH_ABOUT_PAGE)}}>跳转到关于页面</Button>
            <WhiteSpace />
            <Button type="primary"
                    onPress={() => {this.props.navigation.push(PATH_ABOUT_PAGE, {id: 1})}}>带参数跳转到关于页面</Button>
          </View>
          ...
          <View style={localStyle.box}>
            ...
            <Button type="primary" onPress={() => {this.getNetworkData()}}>获取网络数据</Button>
            <WhiteSpace />
            <ScrollView>
