...
import ALTag from '../../../components/al-components/al-tag/ALTag';
  ...
  render() {
    ...
    return <View key={this.props.data.title} style={[styles.alMarginLR20, styles.alMarginBottom30]}>
      <AvatarNickname
        ...
        text1={this.props.data.nickname}
        text2={this.props.data.identity} />
      <View style={{height: 10}}></View>
      <ALImage src={this.props.data.poster} width={React.getScreenWidth() - 40} height={React.getScreenWidth() - 40} radius={20} />
...
{/*        <View>
        ...
        <View style={[styles.alFlexRow]}>
          <View style={[styles.alFlexRow]}>
            ...
            <Text style={{color: '#cdcdcd'}}>{props.data.lookCount}    </Text>
          </View>
          <View style={[styles.alFlexRow]}>
            <ALImage src={require('../../../assets/icon/home/like.png')} width={18} height={18} />
            <Text style={{color: '#cdcdcd'}}>{props.data.likeCount}    </Text>
          </View>
          <View style={[styles.alFlexRow]}>
            <ALImage src={require('../../../assets/icon/home/comment.png')} width={20} height={20} />
            <Text style={{color: '#cdcdcd'}}>{props.data.commentCount}</Text>
          </View>
        </View>
      </View>
    </View>
