...
function ModifySignaturePage(props) {
  ...
  const [sign, setSign] = useState(props.userInfo.sign);
  ...
  return (
    <ALPageContainer showNavBar
      ...
      <WingBlank>
        <View>
          <ALText type={'title'}>修改个性签名</ALText>
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(ModifySignaturePage);
